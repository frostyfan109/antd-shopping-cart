...
import { Menu, Input, Typography, Space } from 'antd'
...
export const CartSelectDropdownMenu =  ({
  ...
  const { carts, activeCart, addCart, updateCart, setActiveCart, openCreateCartModal } = useShoppingCart()
  ...
  return (
    ...
    >
      ...
      {!disableNewCartEntry && (
        <Menu.Item key="menu-new-cart" onClick={ openCreateCartModal }>
          <Space>
            <PlusOutlined />
            New cart
          </Space>
